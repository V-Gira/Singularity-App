...
import { DiceSelector } from "../../../../../components/DiceFab/DiceSelector";
...
export function DiceSelectorForCharacterSheet(props: {
...
DiceSelectorForCharacterSheet.displayName = "DiceSelectorForCharacterSheet";
